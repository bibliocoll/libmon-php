...
$library_url = "http://aleph2.mpg.de";
...
class RSS extends DomDocument {
	...
	function addItem($title, $link, $description, $pubDate, $guid, $aleph_source, $aleph_author, $aleph_author2, $aleph_author3) {
        ...
        $item->appendChild($this->makeTextNode('author', $aleph_author));
        (!empty($aleph_author2) ? $item->appendChild($this->makeTextNode('author2', $aleph_author2)) : '');
        (!empty($aleph_author3) ? $item->appendChild($this->makeTextNode('author3', $aleph_author3)) : '');
